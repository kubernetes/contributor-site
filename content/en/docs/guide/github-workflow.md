...
![Git workflow](/en/docs/guide/git_workflow.png)
...
This workflow is process-specific; for quick start build instructions for [kubernetes/kubernetes](https://git.k8s.io/kubernetes) please [see here](/en/docs/devel/development#building-kubernetes-on-a-local-osshell-environment).
...
3. Check out the pull request [process](/en/docs/guide/pull-requests) for more details and
   advice.
