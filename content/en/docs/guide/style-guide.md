...
- When linking within the same directory, use a relative link.
  ...
  - **Example:**
    ...
    ```
    See the [Code of Conduct](/en/docs/guide/code-of-conduct) for more information
    ```
  - **Example:**
...
[SIG Google groups]: https://github.com/kubernetes/community/blob/master/sig-list.md
[ISO 8601]: https://en.wikipedia.org/wiki/ISO_8601
[kubernetes icon set]: https://github.com/kubernetes/community/blob/master/icons
[API naming convention]: /en/docs/devel/sig-architecture/api-conventions#naming-conventions
