...
Check out our [community guiding principles](/en/docs/guide/collab) on how to create great code as a big group.

Beginner focused information can be found below in [Open a Pull Request](#open-a-pull-request) and [Code Review](#code-review).

For quick reference on contributor resources, we have a handy [contributor cheatsheet](/en/docs/guide/contributor-cheatsheet).
...
For general questions and troubleshooting, use the [standard lines of communication](https://github.com/kubernetes/community/blob/master/communication/README.md) and work through the [troubleshooting guide](https://kubernetes.io/docs/tasks/debug-application-cluster/troubleshooting/).

## GitHub workflow

To check out code to work on, please refer to [the GitHub Workflow Guide](/en/docs/guide/github-workflow).
...
- [Kubernetes-specific github workflow](/en/docs/guide/pull-requests#the-testing-and-merge-workflow).
...
* not having correctly signed the CLA ahead of your first PR (see [Sign the CLA](/en/docs/guide/getting-started#sign-the-cla) section)
...
* Not following [scalability good practices](/en/docs/guide/scalability-good-practices)
...
For a brief description of the importance of code review, please read [On Code Review](/en/docs/guide/expectations#code-review).  
There are two aspects of code review: giving and receiving.

To make it easier for your PR to receive reviews, consider the reviewers will need you to:

* follow the project [coding conventions](/en/docs/guide/coding-conventions)
...
Reviewers, the people giving the review, are highly encouraged to revisit the [Code of Conduct](/code-of-conduct) as well as [community expectations](/en/docs/guide/expectations#expectations-of-reviewers-review-latency) and must go above and beyond to promote a collaborative, respectful community.
...
Testing is the responsibility of all contributors and is in part owned by all SIGs, but is also coordinated by [sig-testing](https://github.com/kubernetes/community/blob/master/sig-testing). 
Refer to the [Testing Guide](/en/docs/devel/sig-testing/testing) for more information.
...
* End-to-end ("e2e"): These are broad tests of overall system behavior and coherence.  These are more complicated as they require a functional kubernetes cluster built from the sources to be tested. A separate [document detailing e2e testing](/en/docs/devel/sig-testing/e2e-tests) and test cases themselves can be found in [kubernetes/test/e2e/](https://git.k8s.io/kubernetes/test/e2e).
* Conformance: These are a set of testcases, currently a subset of the integration/e2e tests, that the Architecture SIG has approved to define the core set of interoperable features that all Kubernetes deployments must support. For more information on Conformance tests please see the [Conformance Testing](/en/docs/devel/sig-architecture/conformance-tests) Document.
...
Refer to the [Issue Triage Guidelines](/en/docs/guide/issue-triage) for more information.
