...
By default, Kubernetes provides built-in predicates and priorities policies documented in [scheduler_algorithm.md](/en/docs/devel/sig-scheduling/scheduler_algorithm).
