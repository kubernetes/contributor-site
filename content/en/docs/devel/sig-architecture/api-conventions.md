...
description: Defining the verbs and resources used in the Kubernetes API.
---
...
[resource usage](https://github.com/kubernetes/community/blob/master/contributors/design-proposals/scheduling/resources.md#usage-data), should be put into separate
...
[here](/en/docs/devel/sig-api-machinery/strategic-merge-patch).
