...
(see: [Kinds of Tests](/en/docs/devel),
...
[kubernetes versioning policy]: https://github.com/kubernetes/community/blob/master/contributors/design-proposals/release/versioning.md#supported-releases-and-component-skew
