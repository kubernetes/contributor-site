...
found at [API Conventions](/en/docs/devel/sig-architecture/api-conventions).
...
number of existing API types and with the [API conventions](/en/docs/devel/sig-architecture/api-conventions).
...
* For [Unions](/en/docs/devel/sig-architecture/api-conventions#unions), sets of fields where at most one should
...
client-gen is flexible. See [this document](/en/docs/devel/sig-architecture/generating-clientset) if you need
...
Check out the [E2E docs](/en/docs/devel/sig-testing/e2e-tests) for detailed information about how to
...
2. Add the field to the API type:
    ...
    * ensure the field is [optional](/en/docs/devel/sig-architecture/api-conventions#optional-vs-required)
