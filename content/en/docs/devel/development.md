...
See the [testing guide](/en/docs/devel/sig-testing/testing) and [end-to-end tests](/en/docs/devel/sig-testing/e2e-tests)
...
the docs on [using go modules to manage dependencies](/en/docs/devel/sig-architecture/vendor).
...
To check out code to work on, please refer to [this guide](/en/docs/guide/github-workflow).
...
[etcd-install]: /en/docs/devel/sig-testing/integration-tests#install-etcd-dependency
...
[Build with Bazel]: /en/docs/devel/sig-testing/bazel
