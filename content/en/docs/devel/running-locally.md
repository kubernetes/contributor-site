...
description: A fast and lightweight local cluster deployment for development
---
...
You need [go](https://golang.org/doc/install) in your path (see [here](/en/docs/devel/development#go-versions) for supported versions), please make sure it is installed and in your ``$PATH``.
