...
should also read [Writing Good e2e Tests](/en/docs/devel/sig-testing/writing-good-e2e-tests)
...
test suite for [Conformance Testing](/en/docs/devel/sig-architecture/conformance-tests). This test must
meet a number of [requirements](/en/docs/devel/sig-architecture/conformance-tests#conformance-test-requirements)
...
For more information on Conformance tests please see the [Conformance Testing](/en/docs/devel/sig-architecture/conformance-tests)
...
You should also know the [testing conventions](/en/docs/guide/coding-conventions#testing-conventions).
