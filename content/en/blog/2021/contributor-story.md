...
Contributor stories are welcome at this domain, kubernetes.dev, following our regular [blogging practices](https://github.com/kubernetes/community/blob/main/sig-docs/blog-subproject/README.md#submit-a-post). The main change is in the location: pull requests can be directed to the [contributor site repository](https://github.com/kubernetes/contributor-site) for this series.
