...
CLI](https://git.k8s.io/community/tree/main/sig-cli)
...
**Maciej**: Our
[charter](https://git.k8s.io/community/tree/main/sig-cli/)
...
calls](https://git.k8s.io/community/tree/main/sig-cli/#meetings)
