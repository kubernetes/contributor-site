...
subproject](https://git.k8s.io/community/blob/main/sig-architecture/README.md#production-readiness-1)_.
...
with 5000 nodes. I’m still involved in [SIG Scalability](https://git.k8s.io/community/blob/main/sig-scalability/README.md)
...
**WT**: The [PRR process](https://git.k8s.io/community/blob/main/sig-architecture/production-readiness.md)
