...
On behalf of the [Structured Logging Working Group](https://git.k8s.io/community/blob/main/wg-structured-logging/README.md) 
and [SIG Instrumentation](https://git.k8s.io/community/tree/main/sig-instrumentation#readme), 
...
By joining [Structured Logging WG](https://git.k8s.io/community/tree/main/wg-structured-logging),
