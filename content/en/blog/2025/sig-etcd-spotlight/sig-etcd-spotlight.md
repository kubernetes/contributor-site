...
Instrumentation](https://git.k8s.io/community/tree/main/sig-instrumentation), where I
...
and PRRs ([Production Readiness Reviews](https://git.k8s.io/community/blob/main/sig-architecture/production-readiness.md),
...
Machinery](https://git.k8s.io/community/blob/main/sig-api-machinery/README.md), 
[SIG Scalability](https://git.k8s.io/community/tree/main/sig-scalability), 
[SIG Testing](https://git.k8s.io/community/tree/main/sig-scalability), 
[SIG Cluster Lifecycle](https://git.k8s.io/community/tree/main/sig-cluster-lifecycle), etc. 

This collaboration helps ensure etcd's development aligns with the needs of the wider Kubernetes
ecosystem. The formation of the [etcd Operator Working Group](https://git.k8s.io/community/blob/main/wg-etcd-operator/README.md) 
...
[SIG etcd meetings](https://git.k8s.io/community/blob/main/sig-etcd/README.md#meetings), 
