...
Group](https://git.k8s.io/community/blob/main/wg-structured-logging/README.md)
...
- Libraries that use the traditional klog logging calls in a binary that has
  ...
  should be modified to support contextual logging. The [migration guide](https://git.k8s.io/community/blob/main/contributors/devel/sig-instrumentation/migration-to-structured-logging.md)
...
The [Structured Logging WG](https://git.k8s.io/community/tree/main/wg-structured-logging)
