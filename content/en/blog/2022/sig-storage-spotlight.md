...
**FSM**: Reading the [SIG Storage charter](https://git.k8s.io/community/blob/main/sig-storage/charter.md) alone it’s clear that SIG Storage covers a lot of ground, could you describe how the SIG is organised?
