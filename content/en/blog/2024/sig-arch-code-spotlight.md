...
[`staging/`](https://github.com/kubernetes/kubernetes/tree/main/staging). The sub-folders in this
...
repo](https://github.com/kubernetes/kubernetes/tree/main/staging/src/k8s.io/client-go).
...
hours](https://github.com/kubernetes/community/tree/main/sig-architecture#meetings) that takes
