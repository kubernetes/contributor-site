...
Cloud Provider](https://git.k8s.io/community/blob/main/sig-cloud-provider/README.md).
...
[README](https://git.k8s.io/community/blob/main/sig-cloud-provider/README.md), I
...
framework](https://git.k8s.io/community/blob/main/sig-cloud-provider/README.md#kubernetes-cloud-provider)
and the [extraction/migration
project](https://git.k8s.io/community/blob/main/sig-cloud-provider/README.md#cloud-provider-extraction-migration). The
...
(https://git.k8s.io/community/blob/main/sig-contributor-experience/README.md):
...
[here](https://git.k8s.io/community/blob/main/sig-cloud-provider/README.md#meetings).
