...
: Recently, many people have been trying to manage batch workloads with Kubernetes, and in 2022,
  ...
  [WG-Batch](https://git.k8s.io/community/blob/main/wg-batch/README.md) for better
...
[meetings](https://git.k8s.io/community/blob/main/sig-scheduling/README.md#meetings).
