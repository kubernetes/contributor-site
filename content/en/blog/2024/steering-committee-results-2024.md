...
The [2024 Steering Committee Election](https://git.k8s.io/community/tree/main/elections/steering/2024) is now complete. The Kubernetes Steering Committee consists of 7 seats, 3 of which were up for election in 2024. Incoming committee members serve a term of 2 years, and all members are elected by the Kubernetes Community.

This community body is significant since it oversees the governance of the entire Kubernetes project. With that great power comes great responsibility. You can learn more about the steering committee’s role in their [charter](https://git.k8s.io/steering/blob/main/charter.md).
...
This governing body, like all of Kubernetes, is open to all. You can follow along with Steering Committee [meeting notes](https://bit.ly/k8s-steering-wd) and weigh in by filing an issue or creating a PR against their [repo](https://git.k8s.io/steering). They have an open meeting on [the first Monday at 8am PT of every month](https://git.k8s.io/steering). They can also be contacted at their public mailing list steering@kubernetes.io.
...
_This post was adapted from one written by the [Contributor Comms Subproject](https://git.k8s.io/community/tree/main/communication/contributor-comms). If you want to write stories about the Kubernetes community, learn more about us._
