...
1) After you login to Discord, click on the **Add a server button** (The `+`
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/add-server.png" width="40%">
   <br>
   <br>
...
2) Copy the invite link from the "Kubernetes Contributor Celebration Invite"
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/join-server.png" width="40%">
   <br> 
   <br> 
3) Two things will happen: You will be directed to the `#instructions-to-connect`
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/instructions-to-connect.png" width="100%">
   <br>
   <br> 
4) The bot will dm you a unique link where you will need to complete a captcha.
   ...
   **NOTE:** On desktop clients, if you did not get a dm from the bot, right click 
   ...
   <br>
   <img align="center" src="/community/events/2021/kcc/dm-from-bot.png" width="100%">
   <br>
   <br>
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/verification.png" width="100%">
   <br>
   <br>
5) After completing the captcha, navigate to the `#code-of-conduct` channel.
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/coc.png" width="100%">
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/coc-emoji.png" width="100%">
   <br> 
   <br>
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/channels.png" width="100%">
   <br> 
   <br>
...
[YAGPDB.xyz]: /community/events/2021/kcc/faq/#what-is-this-yagpdbxyz-and-why-is-it-messaging-me
...
<br>
<br>
<img align="center" src="/community/events/2021/kcc/user-volume.png" width="100%">
<br> 
<br>
...
<br>
<br>
<img align="center" src="/community/events/2021/kcc/voice-video.png" width="40%">
<br> 
<br>
...
1) Begin by clicking on the cog next to your Discord username in the lower left
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/settings-cog.png" width="100%">
   <br> 
   <br>
2) Navigate to the **Voice & Video** section of the User Settings to adjust your
   ...
   <br>
   <br>
   <img align="center" src="/community/events/2021/kcc/voice-video-settings.png" width="100%">
   <br> 
   <br>
...
[FAQ]: /community/events/2021/kcc/faq/
...
<br>
<br>
<img align="center" src="/community/events/2021/kcc/help-channel.png" width="40%">
